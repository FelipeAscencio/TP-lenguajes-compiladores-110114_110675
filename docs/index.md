...
<div align="center">
  <img src="assets/images/banner.png" alt="angLOXg Banner" width="80%">
</div>

# ¡Bienvenido a angLOXg!

Bienvenidos al repositorio oficial de **angLOXg**, nuestro intérprete del lenguaje **Lox** escrito 100% en **Go**.
...
* 🌳 **[Fase 1: Tree-Walk Interpreter](treewalk.html)** — Anotaciones y decisiones clave de la primera entrega.
* ⚡ **[Fase 2: Bytecode Compiler](bytecode.html)** — Anotaciones y decisiones clave de la segunda entrega.
* 🧬 **[Diferencias de implementación y agregados](diferencias.html)** — Funcionalidades extra agregadas y el impacto de programar en Go.
* 📖 **[Bibliografía](bibliografia.html)** — Materiales de estudio e implementaciones de terceros.

*Desarrollado con pasión (y mucho mate 🧉) por **Felipe Santino Ascencio** y **Mateo Castaño**.*
